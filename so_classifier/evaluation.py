...
def evaluate():
    ...
    return get_evaluation_scores(y_val, y_val_predicted_labels_tfidf)
...
#     #  Print: *accuracy*, *F1-score macro/micro/weighted*, *Precision macro/micro/weighted*
#     print('Bag-of-words')
#     print(get_evaluation_scores(y_val, y_val_predicted_labels_mybag))
#     print('Tfidf')
#     print(get_evaluation_scores(y_val, y_val_predicted_labels_tfidf))
#
